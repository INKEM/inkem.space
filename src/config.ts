...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://inkem.space/", // 请替换为你的站点URL，以斜杠结尾
	...
	bangumi: {
		userId: "inkem", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/INKEM",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1948793782",
					external: true,
...
export const announcementConfig: AnnouncementConfig = {
	title: "公告", // 公告标题
	content: "博客仍在建设中，部分功能尚未完善，敬请谅解~", // 公告内容
...
export const umamiConfig = {
	...
	apiKey: import.meta.env.UMAMI_API_KEY || "api_HBQENsZPKiL6QB1MreTD3ShOkzctQEjA", // API密钥优先从环境变量读取，否则使用配置文件中的值
	baseUrl: "https://api.umami.is", // Umami Cloud API地址
	scripts: `
<script defer src="https://cloud.umami.is/script.js" data-website-id="2336e06b-0952-4662-94be-7a28de5e7b4e"></script>
